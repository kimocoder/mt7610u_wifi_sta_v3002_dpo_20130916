...
USB_DEVICE_ID rtusb_dev_id[] = {
	...
	{USB_DEVICE( 0x0e8d,0x7630 )}, /* MT7630U */
	...
	{USB_DEVICE( 0x148f,0x6530 )}, /* MT6370/RT6370 */
	{USB_DEVICE( 0x148f,0x6570 )}, /* MT6570/RT6570 */
	{USB_DEVICE( 0x148f,0x7601 )}, /* MT7601U TP-LINK TL-WN727N v4 */
	{USB_DEVICE( 0x148f,0x760a )}, /* TP-LINK */
	{USB_DEVICE( 0x148f,0x760b )}, /* MT7601U 360 WiFi Dongle */
	...
	{USB_DEVICE( 0x2357,0x010b )}, /* TP-LINK Archer T2UHP (AC600 r0.1) */
	{USB_DEVICE( 0x293c,0x5702 )}, /* Comcast Xfinity KXW02AAA */
	{USB_DEVICE( 0x7392,0xa711 )}, /* Edimax EW-7711ULC/Edimax EW-7711MAC */
	{USB_DEVICE( 0x7392,0xb711 )}, /* Elecom WDC-433SU2M */
	{USB_DEVICE( 0x7392,0xc711 )}, /* devolo Wifi Stick ac (5G) (Edimax) */
